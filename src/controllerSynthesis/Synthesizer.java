...
public class Synthesizer {
	...
	private gLTS getPrioritizedgLTS(gLTS controller) {
	...
	private gLTS getForwardeableLTS(gLTS controller) {
	...
	public gLTS removeCycles(gLTS controller) {
		//controller = getPrioritizedgLTS(controller);
		controller = getForwardeableLTS(controller);
