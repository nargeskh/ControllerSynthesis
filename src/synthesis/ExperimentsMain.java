...
public class ExperimentsMain {
	...
	public static void main(String[] args) throws IOException, NoStateExistException {
		String outPath = "/Volumes/Miscellaneous/Eclipse Workspace/ControllerSyn/IO/outExperiments/";
		String inPath = "/Volumes/Miscellaneous/Eclipse Workspace/ControllerSyn/IO/inExperiments/";
